...
val print_stream_int      : int Streams.stream -> unit
val print_stream_float    : float Streams.stream -> unit
val print_stream_int_list : int list Streams.stream -> unit
...
val string_of_stream_int      : int Streams.stream -> string
val string_of_stream_float    : float Streams.stream -> string
val string_of_stream_int_list : int list Streams.stream -> string
...
val format_stream : (Format.formatter -> 'a -> unit)
                  -> Format.formatter -> 'a Streams.stream -> unit

val format_stream_int      : Format.formatter -> int Streams.stream -> unit
val format_stream_float    : Format.formatter -> float Streams.stream -> unit
val format_stream_int_list : Format.formatter -> int list Streams.stream -> unit
